...
export default function SignUpPage() {
  ...
  const passwordStrength =
    password.length === 0 ? null : password.length < 8 ? "weak" : "strong";
    ...
    <div className="hero-gradient min-h-screen flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <p className="text-gray-500 text-sm mb-6">Start invoicing for free — no credit card needed</p>
              ...
              {passwordStrength && (
                <p
                  className={`mt-1.5 text-xs font-medium ${
                    passwordStrength === "strong" ? "text-[#22C278]" : "text-amber-500"
                  }`}
                >
